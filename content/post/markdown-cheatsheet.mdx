...
| `[!code highlight:X]` | Highlights a specific line range  |
| `[!code ++]`          | Shows as added in diff mode       |
| `[!code --]`          | Shows as removed in diff mode     |
| `[!code word:WORD]`   | Highlights a specific word        |
| `[!code word:WORD:X]` | Highlights a specific word range  | 
...
## Next-Level MDX with `velite` or `mdx-bundler`
