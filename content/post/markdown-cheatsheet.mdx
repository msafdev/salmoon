...
| Syntax                 | Effect                            |
| ---------------------- | --------------------------------- |
| `[!code highlight]`    | Highlights the entire line        |
| `[!code highlight:X]`  | Highlights a specific line number |
| `[!code ++]`           | Shows as added in diff mode       |
| `[!code --]`           | Shows as removed in diff mode     |
| `[!code word:"myVar"]` | Highlights the word `myVar`       |
...
MDX files often use a layout wrapper:
...
## Next-Level MDX with `contentlayer` or `mdx-bundler`

For complex MDX systems, consider using:

- **[Contentlayer](https://www.contentlayer.dev/)** – Type-safe content system for Next.js
- **[MDX Bundler](https://github.com/kentcdodds/mdx-bundler)** – For serverless-compatible MDX rendering
- **[xdm](https://github.com/wooorm/xdm)** – Compiler that powers MDX under the hood
