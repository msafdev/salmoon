  ...
  return (
    <div className="max-w-xl flex flex-col gap-y-4 items-start w-full md:p-4 group">
      ...
      <div className="flex flex-col w-full gap-y-2">
        <Link
          href={"/"}
          className="flex items-center justify-between pl-6 pr-1 py-1 bg-green-200 md:bg-background md:group-hover:bg-green-200 dark:md:group-hover:bg-green-800 dark:bg-green-800 dark:md:bg-background rounded-tl-3xl rounded-e-[50px] rounded-bl-md border-green-500 border md:border-border anim md:group-hover:border-green-500 w-full"
        >
