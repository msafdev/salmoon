const ServiceCard = ({
  ...
  return (
    ...
    >
      <div className="anim flex flex-col justify-between gap-y-2 h-full w-full overflow-hidden rounded-[11px] bg-card/90 p-4 group-hover/card:bg-card/70">
        <Icon className="anim size-4 sm:size-5 shrink-0 rotate-0 text-foreground group-hover/card:-rotate-6" />
