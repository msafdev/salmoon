  ...
  return (
    <div className="flex w-full max-w-sm flex-col gap-4">
      <div className="grid w-full grid-cols-2 gap-4">
        <div className="group/card anim col-span-full aspect-[16/10] h-auto w-full rounded-xl bg-gradient-to-b from-zinc-200 to-zinc-300 p-[1px] dark:from-zinc-700 dark:to-zinc-800 xs:col-span-1 xs:aspect-[10/11]">
