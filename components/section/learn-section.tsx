              ...
              <div className="relative">
                <div className="relative flex h-8 w-7 rounded-l-md rounded-r-sm -outline-offset-1 outline-black/5 dark:outline">
                  ...
                  <div className="dark:to-gray-1000 flex h-full w-full rounded-r-sm border-2 border-l-0 bg-background dark:bg-primary">
                    <Bookmark className="anim-slow absolute -top-[1px] right-1 h-0 w-2 origin-bottom fill-blue-500 text-blue-500 opacity-0 group-hover:h-2 group-hover:opacity-100 group-aria-expanded:h-2 group-aria-expanded:opacity-100" />
                  </div>
                </div>
              </div>
            ...
            {learns.map((item) => {
              return (
                <Link
                  href={item.slug}
                  key={item.slug}
                  className="group/item flex items-center gap-x-3 py-2 pl-11 w-fit"
                >
